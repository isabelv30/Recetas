...
var MenubarSub = React4.memo(React4.forwardRef(function(props, ref) {
  ...
  var createSeparator = function createSeparator2(index) {
    ...
    return React4.createElement("li", separatorProps);
  };
  ...
  var createMenuitem = function createMenuitem2(processedItem, index) {
    ...
    return React4.createElement("li", menuitemProps, React4.createElement("div", contentProps, content), submenu2);
  };
...
var Menubar = React4.memo(React4.forwardRef(function(inProps, ref) {
  ...
  var createProcessedItems = React4.useCallback(function(items) {
